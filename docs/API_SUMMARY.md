...
총 **10개 도메인**, **68개 엔드포인트**로 구성된 공과금 관리 및 AI 절약 추천 서비스
...
## 💳 5. 월간 청구서 (Monthly Bills) - 9개 엔드포인트
...
| GET | `/api/v1/bills/users/{userId}/compare/{utilityType}` | **전월 대비 비교 (특정 유형)** ⭐ |
| GET | `/api/v1/bills/users/{userId}/compare-all` | **전월 대비 전체 비교** ⭐ |
