...
public class MonthlyBillStatisticsResponse {
    ...
    public static MonthlyBillStatisticsResponse of(BigDecimal totalCharge, BigDecimal averageCharge,
            BigDecimal maxCharge, BigDecimal minCharge, Long unpaidCount, List<MonthlyBillResponse> bills) {
        return MonthlyBillStatisticsResponse.builder().totalCharge(totalCharge).averageCharge(averageCharge)
                .maxCharge(maxCharge).minCharge(minCharge).unpaidCount(unpaidCount).bills(bills).build();
    }
}
