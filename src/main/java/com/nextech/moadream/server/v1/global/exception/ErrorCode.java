...
public enum ErrorCode {
    ...
    USER_BILL_NOT_FOUND(HttpStatus.NOT_FOUND, "청구서 정보를 찾을 수 없습니다."),
    USER_BILL_ALREADY_EXISTS(HttpStatus.BAD_REQUEST, "이미 등록된 청구서입니다."),
    USER_SETTING_NOT_FOUND(HttpStatus.NOT_FOUND, "사용자 설정을 찾을 수 없습니다."),
    ...
    SAVINGS_TRACKING_NOT_FOUND(HttpStatus.NOT_FOUND, "절감 추적 정보를 찾을 수 없습니다."),
